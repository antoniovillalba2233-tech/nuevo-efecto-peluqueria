    ...
    extend: {
      ...
      keyframes: {
        ...
        'evento-pulse': {
          ...
          '70%': { boxShadow: '0 0 0 14px rgba(248, 113, 113, 0)' },
      ...
      animation: {
        ...
        'wapp-pulse': 'wapp-pulse 2.4s ease-out infinite',
        'slow-zoom': 'slow-zoom 22s ease-out forwards',
        'evento-pulse': 'evento-pulse 2.2s ease-out infinite',
        'evento-blink': 'evento-blink 1.6s ease-in-out infinite',
      },
      typography: {
        DEFAULT: {
          css: {
